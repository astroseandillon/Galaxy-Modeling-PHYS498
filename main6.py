...
#        file.close()
    ...
    if check_n:
        input("total N = " + str(n_total) + " Press enter key to continue:")
...
#-------------------------- plotting function
def galaxyHistogram(v_initial, v_final, n_total,
                    title1, xlable,
                    binw, binStart=5.4, binStop=15.7,
                    label_vi = "Velocity initial", label_vf = "Velocity final", 
